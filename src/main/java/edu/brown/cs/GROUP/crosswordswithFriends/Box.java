...
/**
 * This class models a box in a crossword puzzle, which is a grid of boxes. Each
 * box contains a boolean that determines whether it is part of a word or not,
 * the letter that goes in it, if it is, and a list of clues that are associated
 * with the words associated with this particular box.
 *
 */
...
public class Box {
  ...
  /**
   * If the constructor has arguments that are a letter, a clue, an orientation,
   * and a score, then all the private instance variables are instantiated with
   * those values.
   * @param l the letter
   * @param c the clue
